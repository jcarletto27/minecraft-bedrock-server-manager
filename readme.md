...
The aplication will create a minecraft bedrock server using docker itzg/docker-minecraft-bedrock-server, assign port, persistent volume. The aplication then give UI to manage this container.
